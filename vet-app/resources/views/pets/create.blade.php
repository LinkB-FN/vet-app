<x-layouts.app title="Registrar Mascota">
    <div class="mx-auto max-w-2xl space-y-6">
        <!-- Header -->
        <div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Registrar Mascota</h1>
            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Registra una nueva mascota en el sistema</p>
        </div>
